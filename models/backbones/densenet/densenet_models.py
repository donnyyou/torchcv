...
class _DenseLayer(nn.Sequential):
    def __init__(self, num_input_features, growth_rate, bn_size, drop_rate, norm_type):
        super(_DenseLayer, self).__init__()
        self.add_module('norm1', ModuleHelper.BatchNorm2d(norm_type=norm_type)(num_input_features)),
        self.add_module('relu1', nn.ReLU(inplace=True)),
        self.add_module('conv1', nn.Conv2d(num_input_features, bn_size *
                        growth_rate, kernel_size=1, stride=1, bias=False)),
        self.add_module('norm2', ModuleHelper.BatchNorm2d(norm_type=norm_type)(bn_size * growth_rate)),
...
class _DenseBlock(nn.Sequential):
    def __init__(self, num_layers, num_input_features, bn_size, growth_rate, drop_rate, norm_type):
...
class _Transition(nn.Sequential):
    def __init__(self, num_input_features, num_output_features, norm_type):
        ...
        self.add_module('norm', ModuleHelper.BatchNorm2d(norm_type=norm_type)(num_input_features))
