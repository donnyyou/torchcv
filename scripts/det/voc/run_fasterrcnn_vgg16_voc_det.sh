...
if [[ "$1"x == "train"x ]]; then
  ${PYTHON} -u main.py --hypes ${CONFIG_FILE} --phase train --log_to_file n --gpu 0 --cudnn n \
  ...
  ${PYTHON} -u main.py --hypes ${CONFIG_FILE} --phase test --log_to_file n --model_name ${MODEL_NAME} \
